...
export const Sidebar = ({ className, ...props }: React.ComponentPropsWithoutRef<'nav'>) => {
  return <nav {...props} className={cn(className, 'flex h-full min-h-0 flex-col')} />
}

export const SidebarHeader = ({ className, ...props }: React.ComponentPropsWithoutRef<'div'>) => {
  return (
    <div
      {...props}
      className={cn(
...
export const SidebarBody = ({ className, ...props }: React.ComponentPropsWithoutRef<'div'>) => {
  return (
    <div
      {...props}
      className={cn(
...
export const SidebarFooter = ({ className, ...props }: React.ComponentPropsWithoutRef<'div'>) => {
  return (
    <div
      {...props}
      className={cn(
...
export const SidebarSection = ({ className, ...props }: React.ComponentPropsWithoutRef<'div'>) => {
  let id = React.useId()
...
export const SidebarDivider = ({ className, ...props }: React.ComponentPropsWithoutRef<'hr'>) => {
  return <hr {...props} className={cn(className, 'my-4 border-t border-zinc-950/5 lg:-mx-4 dark:border-white/5')} />
}

export const SidebarSpacer = ({ className, ...props }: React.ComponentPropsWithoutRef<'div'>) => {
  return <div aria-hidden="true" {...props} className={cn(className, 'mt-8 flex-1')} />
}

export const SidebarHeading = ({ className, ...props }: React.ComponentPropsWithoutRef<'h3'>) => {
  return (
